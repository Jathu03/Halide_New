...
def prepare_data_for_model(train_features, test_features):
    ...
    comps_tensor_third_part = torch.zeros(batch_size_train, 1, expr_embed_size)  # Match expr_embed_size
    ...
    comps_tensor_third_part_test = torch.zeros(batch_size_test, 1, expr_embed_size)
