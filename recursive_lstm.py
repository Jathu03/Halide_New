...
def custom_loss(outputs, targets, huber_delta=0.3, mae_weight=0.5, l1_lambda=2e-5):
...
def train_model(model, train_loader, test_loader, criterion, optimizer, num_epochs=1000, patience=70, accumulation_steps=4):
    ...
    scheduler = CosineAnnealingWarmRestarts(optimizer, T_0=50, T_mult=2, eta_min=5e-7)
...
def main(main_dir):
    ...
    train_losses, val_losses = train_model(
        ...
        num_epochs=1000, patience=70, accumulation_steps=4
    )
